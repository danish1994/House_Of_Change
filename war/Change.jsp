				...
				<div id="horizontalTab"
					...
					<div class="resp-tabs-container">
						<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
							<div class="tab_img">
								<%
										List<PictureDetails> det = ofy().load().type(PictureDetails.class).filter("type","change").filter("valid", true).order("-date").list();
						...
						<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
							<div class="tab_img">
								<%
										List<PictureDetails> detTrending = ofy().load().type(PictureDetails.class).filter("type","change").filter("valid", true).order("-likes").list();
						...
						<div class="tab-2 resp-tab-content" aria-labelledby="tab_item-2">
							<div class="tab_img">
								<%
										List<PictureDetails> detView = ofy().load().type(PictureDetails.class).filter("type","change").filter("valid", true).order("-view").list();
