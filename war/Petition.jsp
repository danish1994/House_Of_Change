				...
				<div class="top-nav">
					...
					<ul>
						...
						<li><a href="/shame.html" class="hvr-bounce-to-top">Hall of
								Shame</a></li>
						<li><a href="/change.html" class="hvr-bounce-to-top">Hall
								of Change</a></li>
			...
			<div class="about-bottom">
				<div class="col-md-6 bottom-about">
					...
					<p align="center">
						...
						<%=date%>
						<br /> Dear
						<%=name%><br /> I would like to apologize for my inappropriate
					...
					<br />
					<form action="/petition" method="post">
						<div class="col-lg-10 in-contact" style="align: left;">
							<input type="text" name="comment"
								style="color: #000; background: #fff">
						</div>
						<br /> <br /> <input type="hidden" name="picID"
							value="<%=picID%>"> <input type="hidden" name="uID"
							value="<%=uID%>"> <input type="submit"
							class="btn btn-primary btn-lg" style="width: 100%;">
					</form>
				</div>
				<div class="col-md-6 bottom-about1">
					<img src="<%=picID%>" style="width: 100%" alt="Petition">
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
